...
agent: build
---
Purpose: update stale docs so the Mintlify docs in this repo match the current Annie Mei implementation.
...
4. Update only docs that are stale, inaccurate, missing key user-facing guidance, or harder to follow than they need to be.
...
Goal: after the update, the docs should clearly match the implementation and be easy for a user to read and follow.

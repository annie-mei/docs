...
Use `/unregister` when you want to remove your AniList account link from Annie Mei.

```text
/unregister confirmation:Confirm unlink
```

This deletes the bot profile link and active stored AniList OAuth credentials associated with your Discord account. Choose `Cancel` for the confirmation option if you do not want to unlink.

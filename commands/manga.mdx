...
<ResponseField name="Guild Data" optional>
  ...
  Annie Mei fetches this data in groups of up to 25 linked members. If AniList cannot return one member or one group, available member results can still appear.
</ResponseField>

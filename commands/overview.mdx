...
<CardGroup cols={2}>
  ...
  <Card title="/studio" icon="building-2" href="/commands/studio">
    Look up anime production studios and notable titles from AniList
  </Card>
...
All lookup commands (`/anime`, `/manga`, `/songs`, `/recommend`, `/character`, `/studio`) accept names or AniList IDs.
...
<Steps>
  ...
  <Step title="Search media">
    Use `/anime`, `/manga`, `/studio`, or `/search` to find titles and studios.
  </Step>

...
description: How Annie Mei processes Discord interactions, optional AniList account links, logs, diagnostics, and deletion requests.
icon: shield
---
...
- Fetch anime, manga, character, user, and theme song information.

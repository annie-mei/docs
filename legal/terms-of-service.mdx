...
description: Terms that apply when you add Annie Mei to a Discord server or use its slash commands.
icon: file-text
---
...
Annie Mei provides Discord slash commands for looking up information from third-party services including AniList, MyAnimeList, and Spotify. Annie Mei may also let you link an AniList account so the bot can show account-specific information, such as Discord server member scores, when you use supported commands.

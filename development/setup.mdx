...
<Steps>
  ...
  <Step title="Run Migrations">
    ...
    This step is optional for a normal local run — the bot expects the database schema to already be in place. See the [Database](/development/database) guide for more details.
  </Step>

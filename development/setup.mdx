...
<Steps>
  ...
  <Step title="Run Migrations">
    The bot does not run migrations and does not own database tables. If you are testing `/register`, run the auth service once to apply its SQLx migrations to the shared database.

...
<Note>
  The bot previously used Diesel ORM. As of v2.15.0, the bot has no Diesel-managed tables. Migrations are now SQLx-based. The legacy `users` table was dropped in migration `2026-05-02-000001_drop_users_table`.
</Note>

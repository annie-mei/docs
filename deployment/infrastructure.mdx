...
The bot repo's `migrations/` directory contains bot-owned migrations for settings tables in the `annie_mei` schema. It is not used to prepare the OAuth schema.

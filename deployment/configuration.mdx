...
The bot automatically runs embedded SQLx migrations on startup. You only need SQLx CLI if you want to run or generate migrations manually during development.

...
Source: [src/models/mal_response.rs:11-33](https://github.com/annie-mei/annie-mei/blob/main/src/models/mal_response.rs#L11-L33)
...
Episode annotations are optional. If MyAnimeList returns an unclosed or otherwise malformed annotation, Annie Mei keeps the song and omits that annotation.

Source: [src/models/mal_response.rs:147-188](https://github.com/annie-mei/annie-mei/blob/main/src/models/mal_response.rs#L147-L188)
...
Source: [src/models/mal_response.rs:199-201](https://github.com/annie-mei/annie-mei/blob/main/src/models/mal_response.rs#L199-L201)
...
Source: [src/models/mal_response.rs:64-72](https://github.com/annie-mei/annie-mei/blob/main/src/models/mal_response.rs#L64-L72)
...
Source: [src/models/mal_response.rs:128-132](https://github.com/annie-mei/annie-mei/blob/main/src/models/mal_response.rs#L128-L132)
...
Source: [src/models/mal_response.rs:203-213](https://github.com/annie-mei/annie-mei/blob/main/src/models/mal_response.rs#L203-L213)

### Optional cover image

Annie Mei prefers the large MyAnimeList image and falls back to the medium image. If `main_picture` or both image URLs are missing, it returns the song embed without a thumbnail.
...
- Missing opening/ending themes display `No theme songs listed yet.`
...
- Missing cover images are omitted from the embed
- Malformed episode annotations do not fail the complete song response

Source: [src/models/mal_response.rs:155-157](https://github.com/annie-mei/annie-mei/blob/main/src/models/mal_response.rs#L155-L157)
